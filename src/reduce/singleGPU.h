...
float commutativeSingleGpuReduction(
    ...
    commutativeKernel<Reduction,typename Reduction::InputElement><<<block_count, BLOCK_SIZE>>>(
    ...
    commutativeKernel<Reduction,typename Reduction::ReturnElement><<<1, BLOCK_SIZE>>>(
